...
func (impl TenantStorerImpl) ListByFilter(ctx context.Context, f *TenantPaginationListFilter) (*TenantPaginationListResult, error) {
	...
	return &TenantPaginationListResult{
		Results:     results,
