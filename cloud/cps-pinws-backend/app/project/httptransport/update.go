...
import (
	...
	sub_s "github.com/LuchaComics/monorepo/cloud/cps-pinws-backend/app/project/datastore"
	"github.com/LuchaComics/monorepo/cloud/cps-pinws-backend/utils/httperror"
	"go.mongodb.org/mongo-driver/bson/primitive"
)

func UnmarshalUpdateRequest(ctx context.Context, r *http.Request) (*sub_s.Project, error) {
	// Initialize our array which will project all the results from the remote server.
...
func ValidateUpdateRequest(dirtyData *sub_s.Project) error {
...
func MarshalUpdateResponse(res *sub_s.Project, w http.ResponseWriter) {
