...
type PinObjectController interface {
	...
	GetByID(ctx context.Context, id primitive.ObjectID) (*domain.PinObject, error)
	UpdateByID(ctx context.Context, ns *PinObjectUpdateRequestIDO) (*domain.PinObject, error)
