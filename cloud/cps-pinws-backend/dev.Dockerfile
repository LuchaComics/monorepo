...
ENTRYPOINT CompileDaemon -polling=true -log-prefix=false -build="go build ." -command="./cps-pinws-backend serve" -directory="./"

# BUILD
# docker build --rm -t cps-pinws-backend -f dev.Dockerfile .

# EXECUTE
# docker run -d -p 8000:8000 cps-pinws-backend
