...
// Provider provides an interface for abstracting `CPS_NFTSTORE Registry Number`.
...
// NewProvider function is a contructor that returns the default `CPS_NFTSTORE Registry Number` provider.
...
const (
	...
	ServiceTypeCPS_NFTSTORECapsule                    = 3
	ServiceTypeCPS_NFTSTORECapsuleIndieMintGem        = 4
	ServiceTypeCPS_NFTSTORECapsuleSignatureCollection = 5
	ServiceTypeCPS_NFTSTORECapsuleYouGrade            = 6
)
...
// Generates the unique `CPS_NFTSTORE Registry Number` required for tracking submissions.
func (p cpsrnProvider) Generate(specialCollection int8, serviceType int8, userRoleID int8, count int64) (string, error) {
	...
	switch serviceType {
	case ServiceTypeCPS_NFTSTORECapsuleYouGrade, ServiceTypeCPS_NFTSTORECapsuleSignatureCollection, ServiceTypeCPS_NFTSTORECapsuleIndieMintGem, ServiceTypeCPS_NFTSTORECapsule:
		// STEP 1: Ensure the correct role was applied.
		switch serviceType {
		case ServiceTypeCPS_NFTSTORECapsuleIndieMintGem, ServiceTypeCPS_NFTSTORECapsule:
