...
func (impl PinObjectStorerImpl) Create(ctx context.Context, u *PinObject) error {
	// DEVELOPER NOTES:
	...
	if u.ID == primitive.NilObjectID {
		...
		impl.Logger.Warn("database insert pinobject not included id value, created id now.", slog.Any("id", u.ID))
	}
