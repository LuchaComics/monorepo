...
func (impl NFTStorerImpl) Create(ctx context.Context, u *NFT) error {
	// DEVELOPER NOTES:
	// According to mongodb documentaiton:
	//     Non-existent Databases and NFTs
	//     If the necessary database and nft don't exist when you perform a write operation, the server implicitly creates them.
	...
	_, err := impl.NFT.InsertOne(ctx, u)
