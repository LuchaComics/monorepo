...
func (c *NFTControllerImpl) UpdateByID(ctx context.Context, ns *domain.NFT) (*domain.NFT, error) {
	...
	os, err := c.NFTStorer.GetByID(ctx, ns.ID)
	if err != nil {
	...
	if err := c.NFTStorer.UpdateByID(ctx, os); err != nil {
