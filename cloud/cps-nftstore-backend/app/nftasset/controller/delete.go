...
func (impl *NFTAssetControllerImpl) DeleteByRequestID(ctx context.Context, requestID primitive.ObjectID) error {
	////
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		// // Update the database.
		// nftasset, err := impl.GetByRequestID(sessCtx, requestID)
		// if err != nil {
		...
		// if err := impl.S3.DeleteByKeys(sessCtx, []string{nftasset.ObjectKey}); err != nil {
		...
		// if err := impl.IPFS.DeleteContent(sessCtx, nftasset.CID); err != nil {
