...
type NFTMetadataPaginationListFilter struct {
	// Pagination related.
	Cursor    string
	PageSize  int64
	SortField string
...
// NFTMetadataPaginationListResult represents the paginated list results for
...
func (impl NFTMetadataStorerImpl) newPaginationFilter(f *NFTMetadataPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl NFTMetadataStorerImpl) newPaginationFilterBasedOnTime(f *NFTMetadataPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl NFTMetadataStorerImpl) newPaginationOptions(f *NFTMetadataPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl NFTMetadataStorerImpl) newPaginatorNextCursor(f *NFTMetadataPaginationListFilter, results []*NFTMetadata) (string, error) {
	var lastDatum *NFTMetadata
