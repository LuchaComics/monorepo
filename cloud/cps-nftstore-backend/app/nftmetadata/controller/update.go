...
type NFTMetadataUpdateRequestIDO struct {
...
func (impl *NFTMetadataControllerImpl) validateUpdateRequest(dirtyData *NFTMetadataUpdateRequestIDO) error {
...
func (impl *NFTMetadataControllerImpl) UpdateByID(ctx context.Context, req *NFTMetadataUpdateRequestIDO) (*domain.NFTMetadata, error) {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		os, err := impl.NFTMetadataStorer.GetByID(sessCtx, req.ID)
		if err != nil {
			impl.Logger.Error("database get by id error", slog.Any("error", err))
			return nil, err
		}
		if os == nil {
			return nil, httperror.NewForBadRequestWithSingleField("id", "nftmetadata type does not exist")
		}
		...
		if err := impl.NFTMetadataStorer.UpdateByID(sessCtx, os); err != nil {
