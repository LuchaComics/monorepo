...
func (c *NFTMetadataControllerImpl) UpdateByID(ctx context.Context, ns *domain.NFTMetadata) (*domain.NFTMetadata, error) {
	...
	os, err := c.NFTMetadataStorer.GetByID(ctx, ns.ID)
	if err != nil {
	...
	if err := c.NFTMetadataStorer.UpdateByID(ctx, os); err != nil {
