...
type ProjectPaginationListFilter struct {
	// Pagination related.
	Cursor    string
	PageSize  int64
	SortField string
...
// ProjectPaginationListResult represents the paginated list results for
// the associate records.
type ProjectPaginationListResult struct {
...
func (impl ProjectStorerImpl) newPaginationFilter(f *ProjectPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl ProjectStorerImpl) newPaginationFilterBasedOnTime(f *ProjectPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl ProjectStorerImpl) newPaginationOptions(f *ProjectPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl ProjectStorerImpl) newPaginatorNextCursor(f *ProjectPaginationListFilter, results []*Project) (string, error) {
	var lastDatum *Project
