...
import (
	...
	sub_s "github.com/LuchaComics/monorepo/cloud/cps-nftstore-backend/app/tenant/datastore"
...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	...
	f := &sub_s.TenantPaginationListFilter{
		Cursor:          "",
		PageSize:        25,
...
func MarshalListResponse(res *sub_s.TenantPaginationListResult, w http.ResponseWriter) {
...
func (h *Handler) PublicListAsSelectOptionByFilter(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
