...
const (
	// TenantPendingStatus indicates this tenant needs to be reviewed by CPS_IPFSSTORE and approved / rejected.
...
type Tenant struct {
	...
	RetailPartnershipReason      string             `bson:"retail_partnership_reason" json:"retail_partnership_reason,omitempty"`       // "Please describe how you could become a good retail partner for CPS_IPFSSTORE"
