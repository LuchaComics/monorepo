...
func (impl PinObjectStorerImpl) UpdateByID(ctx context.Context, m *PinObject) error {
...
func (impl PinObjectStorerImpl) UpdateByRequestID(ctx context.Context, m *PinObject) error {
	filter := bson.D{{"requestid", m.RequestID}}
