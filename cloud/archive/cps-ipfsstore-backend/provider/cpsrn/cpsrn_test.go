...
import (
	...
	"github.com/LuchaComics/monorepo/cloud/cps-ipfsstore-backend/provider/cpsrn"
)
...
func TestGenerateForUGrade(t *testing.T) {
	...
	data := []*GenerateTestCase{
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 0, "788346-26649-5-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 999, "788346-26649-5-1000"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9998, "788346-26649-5-9999"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999, "788346-26649-6-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 1000, "788346-26649-6-1001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9998, "788346-26649-6-9999"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999, "788346-26649-7-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999 + 9998, "788346-26649-7-9999"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999 + 9999, "788346-26649-8-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999 + 9999 + 9998, "788346-26649-8-9999"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999 + 9999 + 9999, "788346-26649-9-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999 + 9999 + 9999 + 9998, "788346-26649-9-9999"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999 + 9999 + 9999 + 9999, "788346-26649-10-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleSignatureCollection, 1, 0, "788346-26649-5-0001"},
	}
...
func TestGenerateForIndieMintGem(t *testing.T) {
	...
	// Success cases.
	data := []*GenerateTestCase{
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleIndieMintGem, cpsrn.UserRoleRoot, 0, "788346-26649-5-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleIndieMintGem, cpsrn.UserRoleRoot, 9998, "788346-26649-5-9999"},
	}
	...
	errDatum := &GenerateTestCase{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleIndieMintGem, 0, 0, "788346-26649-5-0001"}
	...
	// Out of bounds case.
	errDatum2 := &GenerateTestCase{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, 1, 9999 + 9999 + 9999 + 9999 + 9999 + 9999, "788346-26649-10-0001"}
...
func TestClassify(t *testing.T) {
	...
	data := []*ClassifyTestCase{
		...
		{4, 0, 0, "3-0001"},
		{5, 0, 0, "4-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleYouGrade, cpsrn.UserRoleRoot, "5-0001"},
		{0, cpsrn.ServiceTypeCPS_IPFSSTORECapsuleSignatureCollection, cpsrn.UserRoleRoot, "5-0001"},
