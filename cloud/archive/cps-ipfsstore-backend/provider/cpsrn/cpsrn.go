...
// Provider provides an interface for abstracting `CPS_IPFSSTORE Registry Number`.
...
// NewProvider function is a contructor that returns the default `CPS_IPFSSTORE Registry Number` provider.
...
const (
	...
	ServiceTypeCPS_IPFSSTORECapsule                    = 3
	ServiceTypeCPS_IPFSSTORECapsuleIndieMintGem        = 4
	ServiceTypeCPS_IPFSSTORECapsuleSignatureCollection = 5
	ServiceTypeCPS_IPFSSTORECapsuleYouGrade            = 6
)
...
// Generates the unique `CPS_IPFSSTORE Registry Number` required for tracking submissions.
func (p cpsrnProvider) Generate(specialCollection int8, serviceType int8, userRoleID int8, count int64) (string, error) {
	...
	switch serviceType {
	case ServiceTypeCPS_IPFSSTORECapsuleYouGrade, ServiceTypeCPS_IPFSSTORECapsuleSignatureCollection, ServiceTypeCPS_IPFSSTORECapsuleIndieMintGem, ServiceTypeCPS_IPFSSTORECapsule:
		// STEP 1: Ensure the correct role was applied.
		switch serviceType {
		case ServiceTypeCPS_IPFSSTORECapsuleIndieMintGem, ServiceTypeCPS_IPFSSTORECapsule:
