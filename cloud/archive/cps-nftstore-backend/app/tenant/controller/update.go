...
import (
	...
	domain "github.com/LuchaComics/monorepo/cloud/cps-nftstore-backend/app/tenant/datastore"
	s_d "github.com/LuchaComics/monorepo/cloud/cps-nftstore-backend/app/tenant/datastore"
...
func (impl *TenantControllerImpl) UpdateByID(ctx context.Context, ns *domain.Tenant) (*domain.Tenant, error) {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		os.CPS_NFTSTOREPartnershipReason = ns.CPS_NFTSTOREPartnershipReason
		os.Level = ns.Level
