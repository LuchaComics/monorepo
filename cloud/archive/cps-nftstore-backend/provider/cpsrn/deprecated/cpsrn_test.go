...
func TestGenerateNumberForCPS_NFTSTOREAdministrationCSVExport(t *testing.T) {
...
func TestGenerateNumberForCPS_NFTSTOREAdministrationFor19999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPS_NFTSTOREAdministrationFor29999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPS_NFTSTOREAdministrationFor39999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPS_NFTSTOREAdministration(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
