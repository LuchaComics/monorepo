...
func (impl UserPurchaseStorerImpl) Create(ctx context.Context, u *UserPurchase) error {
	// DEVELOPER NOTES:
	...
	if u.ID == primitive.NilObjectID {
		...
		impl.Logger.Warn("database insert store not included id value, created id now.", slog.Any("id", u.ID))
	}
