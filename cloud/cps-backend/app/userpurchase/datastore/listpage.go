...
type UserPurchasePaginationListFilter struct {
	// Pagination related.
	Cursor    string
	PageSize  int64
	SortField string
...
// UserPurchasePaginationListResult represents the paginated list results for
// the associate records.
type UserPurchasePaginationListResult struct {
...
func (impl UserPurchaseStorerImpl) newPaginationFilter(f *UserPurchasePaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl UserPurchaseStorerImpl) newPaginationFilterBasedOnTime(f *UserPurchasePaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl UserPurchaseStorerImpl) newPaginationOptions(f *UserPurchasePaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl UserPurchaseStorerImpl) newPaginatorNextCursor(f *UserPurchasePaginationListFilter, results []*UserPurchase) (string, error) {
	var lastDatum *UserPurchase
