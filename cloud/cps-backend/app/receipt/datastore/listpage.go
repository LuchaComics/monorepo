...
type ReceiptPaginationListFilter struct {
	// Pagination related.
	Cursor    string
	PageSize  int64
	SortField string
...
// ReceiptPaginationListResult represents the paginated list results for
// the associate records.
type ReceiptPaginationListResult struct {
...
func (impl ReceiptStorerImpl) newPaginationFilter(f *ReceiptPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl ReceiptStorerImpl) newPaginationFilterBasedOnTime(f *ReceiptPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl ReceiptStorerImpl) newPaginationOptions(f *ReceiptPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl ReceiptStorerImpl) newPaginatorNextCursor(f *ReceiptPaginationListFilter, results []*Receipt) (string, error) {
	var lastDatum *Receipt
