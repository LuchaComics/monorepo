...
// EventLogPaginationListResult represents the paginated list results for
...
func (impl EventLogStorerImpl) newPaginationFilter(f *EventLogPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl EventLogStorerImpl) newPaginationFilterBasedOnTime(f *EventLogPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl EventLogStorerImpl) newPaginationOptions(f *EventLogPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl EventLogStorerImpl) newPaginatorNextCursor(f *EventLogPaginationListFilter, results []*EventLog) (string, error) {
	var lastDatum *EventLog
