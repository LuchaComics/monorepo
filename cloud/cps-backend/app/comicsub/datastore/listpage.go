...
// ComicSubmissionPaginationListResult represents the paginated list results for
...
func (impl ComicSubmissionStorerImpl) newPaginationFilter(f *ComicSubmissionPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl ComicSubmissionStorerImpl) newPaginationFilterBasedOnTime(f *ComicSubmissionPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl ComicSubmissionStorerImpl) newPaginationOptions(f *ComicSubmissionPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl ComicSubmissionStorerImpl) newPaginatorNextCursor(f *ComicSubmissionPaginationListFilter, results []*ComicSubmission) (string, error) {
	var lastDatum *ComicSubmission
