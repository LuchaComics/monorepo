...
// AttachmentPaginationListResult represents the paginated list results for
...
func (impl AttachmentStorerImpl) newPaginationFilter(f *AttachmentPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl AttachmentStorerImpl) newPaginationFilterBasedOnTime(f *AttachmentPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl AttachmentStorerImpl) newPaginationOptions(f *AttachmentPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl AttachmentStorerImpl) newPaginatorNextCursor(f *AttachmentPaginationListFilter, results []*Attachment) (string, error) {
	var lastDatum *Attachment
