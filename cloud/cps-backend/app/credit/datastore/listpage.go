...
// CreditPaginationListResult represents the paginated list results for
...
func (impl CreditStorerImpl) newPaginationFilter(f *CreditPaginationListFilter) (bson.M, error) {
	if len(f.Cursor) > 0 {
...
func (impl CreditStorerImpl) newPaginationFilterBasedOnTime(f *CreditPaginationListFilter, decodedCursor string) (bson.M, error) {
...
func (impl CreditStorerImpl) newPaginationOptions(f *CreditPaginationListFilter) (*options.FindOptions, error) {
...
// with our paginator.
func (impl CreditStorerImpl) newPaginatorNextCursor(f *CreditPaginationListFilter, results []*Credit) (string, error) {
	var lastDatum *Credit
