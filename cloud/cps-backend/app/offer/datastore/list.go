...
func (impl OfferStorerImpl) ListByFilter(ctx context.Context, f *OfferPaginationListFilter) (*OfferPaginationListResult, error) {
	...
	return &OfferPaginationListResult{
		Results:     results,
