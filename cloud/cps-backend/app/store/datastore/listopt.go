...
func (impl StoreStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *StorePaginationListFilter) ([]*StoreAsSelectOption, error) {
	...
	if f.ExcludeArchived {
		query["status"] = bson.M{"$ne": StoreArchivedStatus} // Do not list archived items! This code
	}
	...
	var results = []*StoreAsSelectOption{}
