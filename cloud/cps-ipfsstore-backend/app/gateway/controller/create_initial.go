...
import (
	...
	org_d "github.com/LuchaComics/monorepo/cloud/cps-ipfsstore-backend/app/tenant/datastore"
...
func (c *GatewayControllerImpl) createInitialRootAdmin(ctx context.Context) error {
	...
	if doesExist == false {
		...
		c.Logger.Info("Root user already exists, skipcps-ipfsstoreg creation.")
	}
	return nil
}
