...
func (impl ProjectStorerImpl) ListByFilter(ctx context.Context, f *ProjectPaginationListFilter) (*ProjectPaginationListResult, error) {
	...
	return &ProjectPaginationListResult{
		Results:     results,
...
func (impl ProjectStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *ProjectPaginationListFilter) ([]*ProjectAsSelectOption, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 12*time.Second)
	defer cancel()
	...
	var results = []*ProjectAsSelectOption{}
