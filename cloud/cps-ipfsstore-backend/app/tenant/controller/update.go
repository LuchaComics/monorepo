...
import (
	...
	domain "github.com/LuchaComics/monorepo/cloud/cps-ipfsstore-backend/app/tenant/datastore"
...
func (impl *TenantControllerImpl) UpdateByID(ctx context.Context, ns *domain.Tenant) (*domain.Tenant, error) {
	...
	transactionFunc := func(sessCtx mongo.SessionContext) (interface{}, error) {
		...
		os.CPS_IPFSSTOREPartnershipReason = ns.CPS_IPFSSTOREPartnershipReason
		os.Level = ns.Level
