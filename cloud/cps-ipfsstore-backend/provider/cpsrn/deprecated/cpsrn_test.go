...
func TestGenerateNumberForCPS_IPFSSTOREAdministrationCSVExport(t *testing.T) {
...
func TestGenerateNumberForCPS_IPFSSTOREAdministrationFor19999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPS_IPFSSTOREAdministrationFor29999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPS_IPFSSTOREAdministrationFor39999(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
...
func TestGenerateNumberForCPS_IPFSSTOREAdministration(t *testing.T) {
	// Create a test instance of cpsrnProvider
	p := cpsrn.NewProvider()
