...
function TokenTransferConfirmView() {
    ////
    //// URL Parameters.
    ////
        ...
        {showErrorBox && (
          <div className="mb-6 bg-red-50 border-l-4 border-red-500 rounded-r-lg p-4 flex items-start gap-3">
            ...
            <div className="flex-grow">
              <h3 className="font-semibold text-red-800">Unable to Transfer Token</h3>
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-yellow-100 rounded-xl">
                  <Send className="w-5 h-5 text-yellow-600" aria-hidden="true" />
                </div>
                <h2 className="text-xl font-bold text-gray-900">Transfer Token</h2>
              </div>
            </div>
            <p className="text-sm text-gray-500">
              Transfer NFT to another address. Please fill in all required fields.
            </p>
          </div>
          ...
          <div className="p-6 space-y-8">
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 flex gap-3">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>All transactions are final and cannot be undone. Please verify all details before transfering.</p>
              </div>
            </div>

            <div className="space-y-6">
              <label className="block">
                <span className="text-sm font-medium text-gray-700">Transfer To <span className="text-red-500">*</span></span>
                <input
                  type="text"
                  name="transferTo"
                  ...
                  className={`mt-1 block w-full px-4 py-3 bg-white border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-colors ${
                    errors.transferTo ? 'border-red-300 bg-red-50' : 'border-gray-200'
                  }`}
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3">
                ...
                <div className="text-sm text-blue-800">
                  <p>A network fee of 1 ComicCoin is required to support the blockchain infrastructure and ensure secure transaction processing.</p>
                </div>
              </div>
            </div>
...
export default TokenTransferConfirmView
