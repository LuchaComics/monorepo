        ...
        {showErrorBox && (
          <div className="mb-6 bg-red-50 border-l-4 border-red-500 rounded-r-lg p-4 flex items-start gap-3">
            ...
            <div className="flex-grow">
              <h3 className="font-semibold text-red-800">Unable to Burn Token</h3>
          ...
          <div className="p-6 space-y-8">
            <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 flex gap-3">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>All transactions are final and cannot be undone. Please verify all details before burning.</p>
              </div>
            </div>
