...
import { WalletMinimal, Send, QrCode, MoreHorizontal, Wallet, AlertCircle, Info, Coins } from 'lucide-react';
...
function SendCoinSubmissionView() {
    ...
    const remainingBalance = formData.amount ? (currentBalance - parseFloat(formData.amount)) : currentBalance;
            ...
            {showErrorBox && (
              <div className="mb-6 bg-red-50 border-l-4 border-red-500 rounded-r-lg p-4 flex items-start gap-3">
                ...
                <div className="flex-grow">
                  <h3 className="font-semibold text-red-800">Unable to Send Coins</h3>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-xl font-bold text-gray-900">Send ComicCoins</h2>
                  </div>
                </div>
                <p className="text-sm text-gray-500">
                  Transfer coins to another wallet address. Please fill in all required fields.
                </p>
              </div>
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="space-y-6">
                  <label className="block">
                    <span className="text-sm font-medium text-gray-700">Pay To <span className="text-red-500">*</span></span>
                    <input
                      type="text"
                      name="recipient"
                      ...
                      className={`mt-1 block w-full px-4 py-3 bg-white border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors ${
                        errors.recipient ? 'border-red-300 bg-red-50' : 'border-gray-200'
                      }`}
                  ...
                  <label className="block">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium text-gray-700">Coins <span className="text-red-500">*</span></span>
                    ...
                    {errors.amount ? (
                      ...
                      <p className="mt-1.5 text-sm text-gray-500">
                        Remaining balance after transaction: {remainingBalance.toFixed(2)} CC
                      </p>
                    )}
                  </label>
                  ...
                  <label className="block">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs text-gray-500">Include a note with your transaction</span>
                    </div>
                    <textarea
                      name="message"
                  ...
                  <label className="block">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium text-gray-700">Wallet Password <span className="text-red-500">*</span></span>
                    </div>
                    <input
                      type="password"
                      name="password"
