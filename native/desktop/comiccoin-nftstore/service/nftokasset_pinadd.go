...
type NFTAssetPinAddService struct {
	logger                 *slog.Logger
...
func (uc *NFTAssetPinAddService) Execute(ctx context.Context, req *PinObjectCreateServiceRequestIDO) (*PinObjectCreateServiceResponseIDO, error) {
	//
	// STEP 1:
	// Validation.
	//
