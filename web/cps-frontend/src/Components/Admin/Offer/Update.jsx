        ...
        <section class="section">
          ...
          <nav className="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link to={`/admin/offer/${id}`} aria-current="page">
          ...
          <nav class="box">
            ...
            <div class="container">
              ...
              <hr />
              <p>
                Please note some of the fields are <i>read-only</i> and can only
                be edited via{" "}
                <Link to="https://stripe.com" target="_blank" rel="noreferrer">
                  Stripe, Inc.&nbsp;
                  <FontAwesomeIcon
                    className="fas"
