...
function RetailerComicSubmissionAddStep11CheckoutLaunchpad() {
  ////
  //// URL Parameters.
  ////
  ...
  function onComicSubmissionDetailSuccess(response) {
    ...
    if (
      ...
      setForceURL("/submissions/comics/add/confirmation?submission_id=" + response.id);
      return;
    }
...
export default RetailerComicSubmissionAddStep11CheckoutLaunchpad;
