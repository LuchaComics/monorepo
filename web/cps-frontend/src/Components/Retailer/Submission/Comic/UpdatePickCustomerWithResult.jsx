        ...
        <div class="modal-card">
          <header class="modal-card-head">
            ...
            <button
              class="delete"
              aria-label="close"
              onClick={(e) => setShowEditWarning(false)}
            ></button>
          </header>
          <section class="modal-card-body">
            Your submission will be have changed the customer. Do you want to
            continue?
          </section>
          <footer class="modal-card-foot">
            <button
              class="button is-success"
              onClick={onCustomerAgreedToChangeClick}
            >
              Yes
            </button>
            <button class="button" onClick={(e) => setShowEditWarning(false)}>
              No
            </button>
          </footer>
        </div>
        ...
        <section class="section">
          ...
          <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link to={`/submissions/comic/${id}/cust`} aria-current="page">
                            ...
                            <article class="message is-primary">
                              <div class="message-body">
                                ...
                                <button
                                  ...
                                  onClick={(e, c) =>
                                    onCustomerPickClick(e, customer.id)
                                  }
                                >
                                  <FontAwesomeIcon
                                    className="fas"
            ...
            <div class="columns pt-5">
              <div class="column is-half">
                <Link
                  ...
                  to={`/submissions/comic/${id}/cust/search`}
                >
                  <FontAwesomeIcon className="fas" icon={faArrowLeft} />
                  &nbsp;Back
                </Link>
