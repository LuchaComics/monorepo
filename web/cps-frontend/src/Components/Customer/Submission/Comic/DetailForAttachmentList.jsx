...
import CustomerComicSubmissionDetailForAttachmentDesktop from "./DetailForAttachmentListDektop";
import CustomerComicSubmissionDetailForAttachmentMobile from "./DetailForAttachmentListMobile";

function CustomerComicSubmissionDetailForAttachmentList() {
  ////
  //// URL Parameters.
  ////
            ...
            <div class="columns">
              ...
              {submission && (
                <div class="column has-text-right">
                  {/* Mobile Specific */}
                  <Link
                    to={`/c/submissions/comic/${id}/attachments/add`}
                ...
                {submission && (
                  <div class="container">
                    <div class="tabs is-medium is-size-7-mobile">
                      <ul>
                        <li>
                          <Link to={`/c/submissions/comic/${id}`}>Detail</Link>
                        </li>
                        <li>
                      ...
                      <div class="container">
                        ...
                        */}
                        <div class="is-hidden-touch">
                          <CustomerComicSubmissionDetailForAttachmentDesktop
                            submissionID={id}
                        ...
                        */}
                        <div class="is-fullwidth is-hidden-desktop">
                          <CustomerComicSubmissionDetailForAttachmentMobile
                            submissionID={id}
                            listData={attachments}
                            setPageSize={setPageSize}
                            pageSize={pageSize}
...
export default CustomerComicSubmissionDetailForAttachmentList;
