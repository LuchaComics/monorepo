...
*/
function CustomerComicSubmissionDetailForAttachmentMobile(props) {
  const {
    submissionID,
    listData,
    setPageSize,
            ...
            <div class="mb-5">
              ...
              <div class="is-hidden-mobile pt-2">
                <div class="buttons is-right">
                  <Link
                    to={`/c/submissions/comic/${submissionID}/attachment/${datum.id}`}
                  ...
                  <Link
                    to={`/c/submissions/comic/${submissionID}/attachment/${datum.id}/edit`}
...
export default CustomerComicSubmissionDetailForAttachmentMobile;
