...
export function postComicSubmissionCreateAPI(
  ...
  axios
    .post(CPS_COMIC_SUBMISSIONS_API_ENDPOINT, decamelizedData)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function getComicSubmissionDetailAPI(
  ...
  const axios = getCustomAxios(onUnauthorizedCallback);
  axios
    .get(CPS_COMIC_SUBMISSION_API_ENDPOINT.replace("{id}", submissionID))
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function putComicSubmissionUpdateAPI(
  ...
  axios
    .put(
      CPS_COMIC_SUBMISSION_API_ENDPOINT.replace("{id}", decamelizedData.id),
      decamelizedData,
    )
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function deleteComicSubmissionAPI(
  ...
  const axios = getCustomAxios(onUnauthorizedCallback);
  axios
    .delete(CPS_COMIC_SUBMISSION_API_ENDPOINT.replace("{id}", id))
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function postComicSubmissionCustomerSwapOperationAPI(
  ...
  axios
    .post(CPS_COMIC_SUBMISSION_CUSTOMER_SWAP_OPERATION_API_ENDPOINT, data)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function postComicSubmissionCreateCommentOperationAPI(
  ...
  axios
    .post(CPS_COMIC_SUBMISSION_CREATE_COMMENT_OPERATION_API_ENDPOINT, data)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function postComicSubmissionFileAttachmentCreateAPI(
  ...
  axios
    .post(
      CPS_COMIC_SUBMISSION_FILE_ATTACHMENTS_API_ENDPOINT.replace(
        "{id}",
        submissionID,
      ),
      formdata,
