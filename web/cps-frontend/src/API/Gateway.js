...
import {
  ...
  CPS_REGISTER_BUSINESS_API_ENDPOINT,
  CPS_REGISTER_CUSTOMER_API_ENDPOINT,
...
export function postRegisterBusinessAPI(
  ...
  customAxios
    .post(CPS_REGISTER_BUSINESS_API_ENDPOINT, decamelizedData)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function postRegisterCustomerAPI(
  ...
  customAxios
    .post(CPS_REGISTER_CUSTOMER_API_ENDPOINT, decamelizedData)
    .then((successResponse) => {
      const responseData = successResponse.data;
