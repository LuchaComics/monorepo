...
*/
function AdminTenantDetailForPinObjectListMobile(props) {
  const {
    submissionID,
    listData,
    setPageSize,
            ...
            <div class="mb-5">
              ...
              <div class="is-hidden-mobile pt-2">
                <div class="buttons is-right">
                  <Link
                    to={`/submissions/comic/${submissionID}/pinobject/${datum.id}`}
                  ...
                  <Link
                    to={`/submissions/comic/${submissionID}/pinobject/${datum.id}/edit`}
                  ...
                  <button
                    onClick={(e, ses) =>
                      onSelectPinObjectForDeletion(e, datum)
                    }
...
export default AdminTenantDetailForPinObjectListMobile;
