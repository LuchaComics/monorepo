...
function AdminTenantDetailForPinObjectListDesktop(props) {
  const {
    tenantID,
    listData,
    setPageSize,
                  ...
                  <tr>
                    ...
                    <td class="is-actions-cell">
                      <div class="buttons is-right">
                        <Link
                          to={`/admin/tenant/${tenantID}/pinobject/${pinobject.id}`}
                        ...
                        <Link
                          to={`/admin/tenant/${tenantID}/pinobject/${pinobject.id}/edit`}
...
export default AdminTenantDetailForPinObjectListDesktop;
