...
// import AdminComicSubmissionAddStep5 from "./Components/Admin/Submission/Comic/AddStep05";
// import AdminComicSubmissionAddStep6 from "./Components/Admin/Submission/Comic/AddStep06";
...
import VerificationApplicationPage from "./Components/User/Verification/View";
        ...
        <Router>
          ...
          <Routes>
            {/*
              ...
              <Route
                exact
                path="/admin/submissions/comics/add/step-5"
                element={<AdminComicSubmissionAddStep5 />}
              />
              <Route
                exact
                path="/admin/submissions/comics/add/step-6"
                element={<AdminComicSubmissionAddStep6 />}
              />
              <Route
                exact
                path="/admin/submissions/comics/add/step-7"
                element={<AdminComicSubmissionAddStep7 />}
              />
              <Route
                exact
                path="/admin/submissions/comics/add/step-8"
                element={<AdminComicSubmissionAddStep8 />}
              />
              <Route
                exact
                path="/admin/submissions/comics/add/step-9"
                element={<AdminComicSubmissionAddStep9 />}
              />
              <Route
                exact
              ...
              <Route
                exact
                path="/admin/submissions/comics/add/step-11/confirmation"
                element={<AdminComicSubmissionAddStep11Confirmation />}
              />
              <Route
                exact
              ...
              <Route
                ...
                element={
                  <RetailerComicSubmissionAddStep11CheckoutLaunchpad />
                }
              />
              <Route
                exact
              ...
              />
              <Route exact path="/help" element={<DashboardHelp />} />
              <Route
                exact
                path="/cpsrn"
                element={<ComicCoinFaucetRedirector />}
              /> */}
