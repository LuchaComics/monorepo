...
function AdminSubmissionAttachmentAdd() {
  ...
  function onAdminSubmissionAttachmentAddSuccess(response) {
    ...
    setTimeout(() => {
      console.log(
        "onAdminSubmissionAttachmentAddSuccess: Delayed for 2 seconds.",
      );
      console.log(
        "onAdminSubmissionAttachmentAddSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminSubmissionAttachmentAddError(apiErr) {
    ...
    setTimeout(() => {
      console.log(
        "onAdminSubmissionAttachmentAddError: Delayed for 2 seconds.",
      );
      console.log(
        "onAdminSubmissionAttachmentAddError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
