        ...
        listData.results.map(function (datum, i) {
          return (
            <div class="mb-5">
              ...
              <br />
              <br />
              <strong>COMICCOIN_FAUCETR #:</strong>&nbsp;{datum.cpsrn}
              <br />
              <br />
              ...
              {datum.customerId !== undefined &&
              datum.customerId !== null &&
              datum.customerId !== "" ? (
                <>
                  {datum.customerId !== "000000000000000000000000" && (
                    <Link
                      to={`/admin/user/${datum.customerId}`}
                      target="_blank"
                      rel="noreferrer"
                      class="is-small"
                    >
                      {datum.customerFirstName}&nbsp;{datum.customerLastName}
                      &nbsp;
                      <FontAwesomeIcon
                        className="fas"
                        icon={faArrowUpRightFromSquare}
