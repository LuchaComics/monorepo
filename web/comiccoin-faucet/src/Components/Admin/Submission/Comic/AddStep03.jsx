...
function AdminComicSubmissionAddStep3() {
  ...
  const onSaveAndContinueClick = (e) => {
    ...
    console.log("onSaveAndContinueClick: SERVICE_TYPE_COMICCOIN_FAUCET_CAPSULE_INDIE_MINT_GEM:", SERVICE_TYPE_COMICCOIN_FAUCET_CAPSULE_INDIE_MINT_GEM);
    ...
    if (serviceType === SERVICE_TYPE_COMICCOIN_FAUCET_CAPSULE_INDIE_MINT_GEM) {
