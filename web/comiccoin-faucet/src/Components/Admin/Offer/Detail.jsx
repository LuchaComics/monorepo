...
function AdminOfferDetail() {
  ...
  const [selectedOfferForDeletion, setSelectedOfferForDeletion] =
    useState(null);
      ...
      <div class="container">
        <section class="section">
          ...
          <nav>
            {/* Delete modal */}
            <div
              class={`modal ${selectedOfferForDeletion !== null ? "is-active" : ""}`}
            >
              ...
              <div class="modal-card">
                <header class="modal-card-head">
                  ...
                  <button
                    class="delete"
                    aria-label="close"
                    onClick={(e, ses) => setSelectedOfferForDeletion(null)}
                  ></button>
                </header>
                <section class="modal-card-body">
                  You cannot delete here. Deletions are handled in{" "}
                  <Link
                    to="https://stripe.com"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  , please login and delete the product and this backend will
              ...
              <>
                {datum && (
                  <div class="container" key={datum.id}>
                    ...
                    <DataDisplayRowText label="Price" value={datum.price} />
