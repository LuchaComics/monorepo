...
function AdminOfferAdd() {
  ...
  const onSubmitClick = (e) => {
    ...
    postOfferCreateAPI(
      decamelizedData,
      onAdminOfferAddSuccess,
      onAdminOfferAddError,
      onAdminOfferAddDone,
    );
  };
  ...
  function onAdminOfferAddSuccess(response) {
    ...
    setTimeout(() => {
      ...
      console.log(
        "onAdminOfferAddSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminOfferAddError(apiErr) {
    ...
    setTimeout(() => {
      ...
      console.log(
        "onAdminOfferAddError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
        ...
        <section class="section">
          ...
          <nav className="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link to="/admin/offers" aria-current="page">
          ...
          <nav class="box">
            ...
            <div class="content container">
              <p class="subtitle is-6">
                <FontAwesomeIcon className="fas" icon={faInfoCircle} />
                &nbsp;How to Add an Offer via Stripe
              </p>
              <hr />
              <p>
                Please follow the following steps if you would like to add an
                offer into the system.
              </p>
              <ol>
                <li>
                  Log into{" "}
                ...
                <li>
                  Fill in the form and please include the following:
                  <ul>
                    <li>Name</li>
                    <li>Description</li>
