...
function CustomerRegistrySearch() {
  ////
  //// URL Parameters.
  ////
        ...
        <section class="section">
          ...
          <nav class="box">
            ...
            <div class="container pb-5">
              ...
              <FormInputField
                label="Lookup COMICCOIN_FAUCETRN"
                name="cpsrn"
...
export default CustomerRegistrySearch;
