...
function CustomerComicSubmissionUpdateForComicSubmission() {
  ////
  //// URL Parameters.
  ////
  ...
  const cpsPercentageGradeFilterOptions = (
    options,
    storeLevel,
    serviceType,
  ) => {
  ...
  // Special thanks via:
  // https://github.com/LuchaComics/comiccoin-faucet/issues/160
  const overallNumberGradeFilterOptions = (
    options,
    storeLevel,
    serviceType,
  ) => {
  ...
  function onComicSubmissionUpdateSuccess(response) {
    ...
    setForceURL("/c/submissions/comic/" + response.id);
  }
        ...
        <section class="section">
          ...
          <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link to={`/c/submissions/comic/${id}`} aria-current="page">
              ...
              <>
                <div class="container">
                  ...
                  <FormComicSignaturesTable
                    ...
                    helpText={
                      <>
                        Only available to COMICCOIN_FAUCET,{" "}
                  ...
                  {serviceType !== SERVICE_TYPE_COMICCOIN_FAUCET_CAPSULE_INDIE_MINT_GEM && (
                    <>
                      <p class="subtitle is-6">
                        <FontAwesomeIcon
                          className="fas"
                      ...
                      {gradingScale === 3 && (
                        <FormSelectField
                          ...
                          placeholder="COMICCOIN_FAUCET Percentage Grade"
...
export default CustomerComicSubmissionUpdateForComicSubmission;
