...
import {
  ...
  COMICCOIN_FAUCET_PERCENTAGE_GRADE_OPTIONS,
...
import { SERVICE_TYPE_COMICCOIN_FAUCET_CAPSULE_INDIE_MINT_GEM } from "../../../../Constants/App";
import {
...
function CustomerComicSubmissionDetail() {
  ////
  //// URL Parameters.
  ////
      ...
      <div class={`modal ${showCustomerEditOptions ? "is-active" : ""}`}>
        ...
        <div class="modal-card">
          ...
          <section class="modal-card-body">
            ...
            <br />
            <Link
              to={`/c/submissions/comic/${submission.id}/customer/search`}
            ...
            {submission && (
              <div class="columns">
                ...
                <div class="column has-text-right">
                  <Link
                    to={`/c/submissions/comic/${submission.id}/edit`}
                  ...
                  <div class="container">
                    <div class="tabs is-medium is-size-7-mobile">
                      <ul>
                        ...
                        <li>
                          <Link to={`/c/submissions/comic/${id}/comments`}>
                            Comments
                          </Link>
                        </li>
                        <li>
                          <Link to={`/c/submissions/comic/${id}/file`}>File</Link>
                        </li>
                        <li>
                          <Link to={`/c/submissions/comic/${id}/attachments`}>
                            Attachments
                          </Link>
                        </li>
                      </ul>
                    ...
                    {submission.serviceType !==
                      ...
                      <>
                        ...
                        <FormTextChoiceRow
                          ...
                          opt3Value={3}
                          opt3Label="COMICCOIN_FAUCET Percentage (5%-100%)"
                        />
                        ...
                        {submission && submission.gradingScale === 3 && (
                          <DataDisplayRowSelect
                            label="COMICCOIN_FAUCET Percentage Grade"
                            selectedValue={submission.cpsPercentageGrade}
                            helpText=""
                            options={COMICCOIN_FAUCET_PERCENTAGE_GRADE_OPTIONS}
                          />
                        )}
                      </>
                    )}
                    ...
                    {submission && (
                      <FormRowText
                        label="COMICCOIN_FAUCETR #"
                        value={submission.cpsrn}
                        helpText="The unique identifier used by COMICCOIN_FAUCET for all submissions"
                      />
                    )}
                    ...
                    <div class="columns pt-4">
                      ...
                      <div class="column is-half has-text-right">
                        <Link
                          to={`/c/submissions/comic/${id}/edit`}
...
export default CustomerComicSubmissionDetail;
