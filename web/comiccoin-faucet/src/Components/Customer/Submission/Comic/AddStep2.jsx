...
function CustomerComicSubmissionAddStep2() {
  ////
  //// URL Arguments.
  ////
  ...
  function onComicSubmissionDetailSuccess(response) {
    ...
    if (
      ...
      setForceURL("/c/submissions/comics/add/" + response.id + "/confirmation");
      return;
    }
            ...
            <>
              ...
              <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                <ul>
                  ...
                  <li class="">
                    <Link to="/c/customers" aria-current="page">
                  ...
                  <div class="columns pt-5">
                    <div class="column is-half">
                      {customerName === null ? (
                        ...
                        <div class="">
                          <Link
                            to={`/c/customer/${customerID}/comics`}
                            class="button is-medium is-secondary is-fullwidth-mobile"
                          >
                            <FontAwesomeIcon
                              className="fas"
...
export default CustomerComicSubmissionAddStep2;
