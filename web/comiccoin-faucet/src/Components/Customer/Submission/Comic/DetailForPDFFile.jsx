...
function CustomerComicSubmissionDetailForPDFFile() {
  ////
  //// URL Parameters.
  ////
                  ...
                  <div class="container">
                    <div class="tabs is-medium is-size-7-mobile">
                      <ul>
                        ...
                        <li class={`is-active`}>
                          <Link to={`/c/submissions/comic/${id}/file`}>
                            <b>File</b>
                          </Link>
                        </li>
                        <li>
                    ...
                    <p class="has-text-grey pb-4">
                      Click the following "Download PDF" button to start
                      downloading a copy of this submission in PDF file format
                      to your computer.
                    </p>
...
export default CustomerComicSubmissionDetailForPDFFile;
