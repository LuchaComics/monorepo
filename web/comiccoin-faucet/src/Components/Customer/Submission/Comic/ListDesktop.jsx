...
function CustomerComicSubmissionListDesktop(props) {
  const {
    listData,
    setPageSize,
    pageSize,
          ...
          <tbody>
            {listData &&
              ...
              listData.results.map(function (submission, i) {
                return (
                  <tr>
                    <td data-label="COMICCOIN_FAUCETR #">{submission.cpsrn}</td>
                    ...
                    <td class="is-actions-cell">
                      <div class="buttons is-right">
                        <Link
                          to={`/c/submissions/comic/${submission.id}`}
...
export default CustomerComicSubmissionListDesktop;
