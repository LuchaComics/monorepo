...
function CustomerComicSubmissionDetailForAttachmentDesktop(props) {
  const {
    submissionID,
    listData,
    setPageSize,
                  ...
                  <tr>
                    ...
                    <td class="is-actions-cell">
                      <div class="buttons is-right">
                        <Link
                          to={`/c/submissions/comic/${submissionID}/attachment/${attachment.id}`}
                        ...
                        <Link
                          to={`/c/submissions/comic/${submissionID}/attachment/${attachment.id}/edit`}
...
export default CustomerComicSubmissionDetailForAttachmentDesktop;
