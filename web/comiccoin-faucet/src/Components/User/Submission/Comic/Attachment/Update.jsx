...
function CustomerSubmissionAttachmentUpdate() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = (e) => {
    ...
    putAttachmentUpdateAPI(
      id,
      formData,
      onCustomerSubmissionAttachmentUpdateSuccess,
      onCustomerSubmissionAttachmentUpdateError,
      onCustomerSubmissionAttachmentUpdateDone,
      onUnauthorized,
    );
  ...
  function onCustomerSubmissionAttachmentUpdateSuccess(response) {
    // For debugging purposes only.
    console.log("onCustomerSubmissionAttachmentUpdateSuccess: Starting...");
    ...
    setTimeout(() => {
      console.log(
        "onCustomerSubmissionAttachmentUpdateSuccess: Delayed for 2 seconds.",
      );
      console.log(
        "onCustomerSubmissionAttachmentUpdateSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
    ...
    setForceURL("/c/submissions/comic/" + id + "/attachments");
  }

  function onCustomerSubmissionAttachmentUpdateError(apiErr) {
    console.log("onCustomerSubmissionAttachmentUpdateError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log(
        "onCustomerSubmissionAttachmentUpdateError: Delayed for 2 seconds.",
      );
      console.log(
        "onCustomerSubmissionAttachmentUpdateError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onCustomerSubmissionAttachmentUpdateDone() {
    console.log("onCustomerSubmissionAttachmentUpdateDone: Starting...");
    setFetching(false);
  }
        ...
        <section class="section">
          ...
          <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link
                  to={`/c/submissions/comic/${id}/attachment/${aid}`}
                  aria-current="page"
                >
...
export default CustomerSubmissionAttachmentUpdate;
