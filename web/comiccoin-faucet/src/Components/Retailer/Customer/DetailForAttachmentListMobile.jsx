            ...
            <div class="mb-5">
              ...
              <div class="is-hidden-mobile pt-2">
                <div className="buttons is-right">
                  <Link
                    to={`/customer/${datum.userId}/attachment/${datum.id}`}
                  ...
                  <Link
                    to={`/customer/${datum.userId}/attachment/${datum.id}/edit`}
              ...
              <div class="is-hidden-tablet pt-2">
                <div class="columns is-mobile">
                  <div class="column">
                    <Link
                      to={`/customer/${userID}/attachment/${datum.id}`}
                  ...
                  <div class="column">
                    <Link
                      to={`/customer/${userID}/attachment/${datum.id}/edit`}
