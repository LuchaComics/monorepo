...
function RetailerCustomerAttachmentUpdate() {
  ...
  function onRetailerCustomerAttachmentUpdateSuccess(response) {
    ...
    setTimeout(() => {
      console.log(
        "onRetailerCustomerAttachmentUpdateSuccess: Delayed for 2 seconds.",
      );
      console.log(
        "onRetailerCustomerAttachmentUpdateSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onRetailerCustomerAttachmentUpdateError(apiErr) {
    ...
    setTimeout(() => {
      console.log(
        "onRetailerCustomerAttachmentUpdateError: Delayed for 2 seconds.",
      );
      console.log(
        "onRetailerCustomerAttachmentUpdateError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onRetailerCustomerAttachmentDetailError(apiErr) {
    ...
    setTimeout(() => {
      console.log(
        "onRetailerCustomerAttachmentDetailError: Delayed for 2 seconds.",
      );
      console.log(
        "onRetailerCustomerAttachmentDetailError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
        ...
        <section class="section">
          ...
          <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link to={`/customer/${id}/attachments`} aria-current="page">
