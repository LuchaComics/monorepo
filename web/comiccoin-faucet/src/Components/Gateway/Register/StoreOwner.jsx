...
function RegisterAsStoreOwner() {
  ...
  const [cpsPartnershipReason, setCOMICCOIN_FAUCETPartnershipReason] = useState("");
  ...
  const onSubmitClick = (e) => {
    ...
    const submission = {
      ...
      COMICCOIN_FAUCETPartnershipReason: cpsPartnershipReason,
          ...
          <nav class="box">
            ...
            {!isFetching && (
              <div class="container">
                ...
                <FormTextareaField
                  label="Please describe how you could become a good retail partner for COMICCOIN_FAUCET"
                ...
                <FormTextareaField
                  label="Please describe how COMICCOIN_FAUCET could help you grow your business"
                  name="cpsPartnershipReason"
                  placeholder="Text input"
                  value={cpsPartnershipReason}
                  errorText={errors && errors.cpsPartnershipReason}
                  helpText=""
                  onChange={(e) => setCOMICCOIN_FAUCETPartnershipReason(e.target.value)}
                  isRequired={true}
                  maxWidth="280px"
                  helpText={""}
                  rows={4}
