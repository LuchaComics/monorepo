...
export function getCollectionListAPI(
  ...
  axios
    ...
    .then((successResponse) => {
      ...
      // Bugfixes.
      console.log("getCollectionListAPI | pre-fix | results:", data);
      if (
      ...
      console.log("getCollectionListAPI | post-fix | results:", data);
...
export function getCollectionSelectOptionListAPI(
  filtersMap = new Map(),
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
  ...
  axios
    ...
    .then((successResponse) => {
      ...
      // Bugfixes.
      console.log("getCollectionSelectOptionListAPI | pre-fix | results:", data);
      if (
        data.results !== undefined &&
        data.results !== null &&
        data.results.length > 0
      ...
      console.log("getCollectionSelectOptionListAPI | post-fix | results:", data);
...
export function postCollectionCreateAPI(
  data,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function getCollectionDetailAPI(
  collectionID,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function putCollectionUpdateAPI(
  data,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function deleteCollectionAPI(
  id,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function postCollectionCreateCommentOperationAPI(
  collectionID,
  content,
  onSuccessCallback,
  onErrorCallback,
...
export function postCollectionStarOperationAPI(
  collectionID,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function postArchiveCollectionAPI(
  id,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function postUpgradeCollectionAPI(
  decamelizedData,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function postDowngradeCollectionAPI(
  id,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function postAvatarCollectionAPI(
  formdata,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
// export function getCollectionSelectOptionListAPI(filtersMap=new Map(), onSuccessCallback, onErrorCallback, onDoneCallback, onUnauthorizedCallback) {
//     const axios = getCustomAxios(onUnauthorizedCallback);
//
//     // The following code will generate the query parameters for the url based on the map.
//     let aURL = CPS_NFT_COLLECTIONS_SELECT_OPTIONS_API_ENDPOINT;
...
export function postCollectionChangePasswordAPI(
  data,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function postCollectionChangeTwoFactorAuthenticationAPI(
  data,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
...
export function getCollectionTokenURIOperationAPI(
  ...
  const axios = getCustomAxios(onUnauthorizedCallback);
  axios
    .get(CPS_NFT_COLLECTION_GET_TOKEN_URI_OPERATION_API_URL.replace("{collectionID}", collectionID).replace("{tokenID}", tokenID))
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function postCollectionMintOperationAPI(
  data,
  onSuccessCallback,
  onErrorCallback,
  onDoneCallback,
  ...
  const axios = getCustomAxios(onUnauthorizedCallback);
  axios
    .post(CPS_NFT_COLLECTION_MINT_OPERATION_API_URL, data).then((successResponse) => {
      const responseData = successResponse.data;
