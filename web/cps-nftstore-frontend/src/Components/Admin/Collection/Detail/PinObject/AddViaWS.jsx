...
function AdminCollectionPinObjectAddViaWebService() {
  ////
  //// URL Parameters.
  ////
    ...
    // Convert the FormData object to binary data and pass it directly
     ...
     reader.onload = () => {
       ...
       postIpfsAddFileAPI(
         ...
         onAdminCollectionPinObjectAddViaWebServiceSuccess,
         onAdminCollectionPinObjectAddViaWebServiceError,
         onAdminCollectionPinObjectAddViaWebServiceDone,
         onUnauthorized,
       );
  ...
  function onAdminCollectionPinObjectAddViaWebServiceSuccess(response) {
    // For debugging purposes only.
    console.log("onAdminCollectionPinObjectAddViaWebServiceSuccess: Starting...");
    ...
    setTimeout(() => {
      console.log("onAdminCollectionPinObjectAddViaWebServiceSuccess: Delayed for 2 seconds.");
      console.log(
        "onAdminCollectionPinObjectAddViaWebServiceSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionPinObjectAddViaWebServiceError(apiErr) {
    console.log("onAdminCollectionPinObjectAddViaWebServiceError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log("onAdminCollectionPinObjectAddViaWebServiceError: Delayed for 2 seconds.");
      console.log(
        "onAdminCollectionPinObjectAddViaWebServiceError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionPinObjectAddViaWebServiceDone() {
    console.log("onAdminCollectionPinObjectAddViaWebServiceDone: Starting...");
    setFetching(false);
  }
...
export default AdminCollectionPinObjectAddViaWebService;
