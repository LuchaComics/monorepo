...
function AdminCollectionNFTAddViaWebService() {
  ////
  //// URL Parameters.
  ////
    ...
    // Convert the FormData object to binary data and pass it directly
     ...
     reader.onload = () => {
       ...
       postIpfsAddFileAPI(
         ...
         onAdminCollectionNFTAddViaWebServiceSuccess,
         onAdminCollectionNFTAddViaWebServiceError,
         onAdminCollectionNFTAddViaWebServiceDone,
         onUnauthorized,
       );
  ...
  function onAdminCollectionNFTAddViaWebServiceSuccess(response) {
    // For debugging purposes only.
    console.log("onAdminCollectionNFTAddViaWebServiceSuccess: Starting...");
    ...
    setTimeout(() => {
      console.log("onAdminCollectionNFTAddViaWebServiceSuccess: Delayed for 2 seconds.");
      console.log(
        "onAdminCollectionNFTAddViaWebServiceSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionNFTAddViaWebServiceError(apiErr) {
    console.log("onAdminCollectionNFTAddViaWebServiceError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log("onAdminCollectionNFTAddViaWebServiceError: Delayed for 2 seconds.");
      console.log(
        "onAdminCollectionNFTAddViaWebServiceError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionNFTAddViaWebServiceDone() {
    console.log("onAdminCollectionNFTAddViaWebServiceDone: Starting...");
    setFetching(false);
  }
...
export default AdminCollectionNFTAddViaWebService;
