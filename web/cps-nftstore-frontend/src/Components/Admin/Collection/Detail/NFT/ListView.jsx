...
import AdminCollectionDetailForNFTListDesktop from "./DetailForNFTListDektop";
import AdminCollectionDetailForNFTListMobile from "./DetailForNFTListMobile";
import AlertBanner from "../../../../Reusable/EveryPage/AlertBanner";

function AdminCollectionDetailForNFTList() {
  ////
  //// URL Parameters.
  ////
  ...
  const [pinobjects, setNFTs] = useState("");
  ...
  const onSelectNFTForDeletion = (e, pinobject) => {
    console.log("onSelectNFTForDeletion", pinobject);
    setSelectedNFTForDeletion(pinobject);
  };
  ...
  function onNFTDeleteSuccess(response) {
    ...
    setTopAlertMessage("NFT deleted");
    setTimeout(() => {
      console.log(
                      ...
                      <div class="container">
                        ...
                        */}
                        <div class="is-hidden-touch">
                          <AdminCollectionDetailForNFTListDesktop
                            collectionID={id}
                            listData={pinobjects}
                        ...
                        */}
                        <div class="is-fullwidth is-hidden-desktop">
                          <AdminCollectionDetailForNFTListMobile
                            collectionID={id}
                            listData={pinobjects}
                            setPageSize={setPageSize}
                            pageSize={pageSize}
                      ...
                      <div class="container">
                        <article class="message is-dark">
                          <div class="message-body">
                            ...
                            to get started creating a new nft.
                          </div>
                        </article>
                      </div>
                    )}
...
export default AdminCollectionDetailForNFTList;
