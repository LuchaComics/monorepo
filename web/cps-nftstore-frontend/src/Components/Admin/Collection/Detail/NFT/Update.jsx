...
function AdminCollectionNFTUpdate() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = (e) => {
    ...
    putNFTUpdateAPI(
      id,
      formData,
      onAdminCollectionNFTUpdateSuccess,
      onAdminCollectionNFTUpdateError,
      onAdminCollectionNFTUpdateDone,
      onUnauthorized,
    );
  ...
  function onAdminCollectionNFTUpdateSuccess(response) {
    // For debugging purposes only.
    console.log("onAdminCollectionNFTUpdateSuccess: Starting...");
    ...
    setTimeout(() => {
      console.log("onAdminCollectionNFTUpdateSuccess: Delayed for 2 seconds.");
      console.log(
        "onAdminCollectionNFTUpdateSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionNFTUpdateError(apiErr) {
    console.log("onAdminCollectionNFTUpdateError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log("onAdminCollectionNFTUpdateError: Delayed for 2 seconds.");
      console.log(
        "onAdminCollectionNFTUpdateError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionNFTUpdateDone() {
    console.log("onAdminCollectionNFTUpdateDone: Starting...");
    setFetching(false);
  }
...
export default AdminCollectionNFTUpdate;
