...
function AdminCollectionNFTAssetDetail() {
  ////
  //// URL Parameters.
  ////
  ...
  const [selectedNFTAssetRequestIDForDeletion, setSelectedNFTAssetRequestIDForDeletion] =
    useState("");
  ...
  const onDeleteConfirmButtonClick = (e) => {
    ...
    deleteNFTAssetAPI(
      selectedNFTAssetRequestIDForDeletion,
      onNFTAssetDeleteSuccess,
      onNFTAssetDeleteError,
      onNFTAssetDeleteDone,
      onUnauthorized,
    );
  };
  ...
  function onNFTAssetDeleteSuccess(response) {
    console.log("onNFTAssetDeleteSuccess: Starting..."); // For debugging purposes only.
  ...
  function onNFTAssetDeleteError(apiErr) {
    console.log("onNFTAssetDeleteError: Starting..."); // For debugging purposes only.
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log(
        "onNFTAssetDeleteError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onNFTAssetDeleteDone() {
    console.log("onNFTAssetDeleteDone: Starting...");
    setFetching(false);
  }
    ...
    <>
      <div class="container">
        <section class="section">
          ...
          {/* Modals */}
          <div
            class={`modal ${selectedNFTAssetRequestIDForDeletion ? "is-active" : ""}`}
          >
            ...
            <div class="modal-card">
              <header class="modal-card-head">
                ...
                <button
                  ...
                  onClick={(e)=>{
                      e.preventDefault();
                      setSelectedNFTAssetRequestIDForDeletion("");
                  }}
                ></button>
              </header>
                  ...
                  <div class="columns pt-5">
                    ...
                    <div class="column is-half has-text-right">
                      ...
                      <button
                          onClick={(e)=>{
                              e.preventDefault();
                              setSelectedNFTAssetRequestIDForDeletion(rid);
                          }}
...
export default AdminCollectionNFTAssetDetail;
