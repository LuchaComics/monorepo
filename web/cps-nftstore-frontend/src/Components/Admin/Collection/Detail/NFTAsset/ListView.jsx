...
import AdminCollectionDetailForNFTAssetListDesktop from "./DetailForNFTAssetListDektop";
import AdminCollectionDetailForNFTAssetListMobile from "./DetailForNFTAssetListMobile";
import AlertBanner from "../../../../Reusable/EveryPage/AlertBanner";

function AdminCollectionDetailForNFTAssetList() {
  ////
  //// URL Parameters.
  ////
  ...
  const fetchNFTAssetList = (cur, collectionID, limit) => {
    setFetching(true);
    setErrors({});
  ...
  const onDeselectNFTAssetForDeletion = (e) => {
    console.log("onDeselectNFTAssetForDeletion");
    setSelectedNFTAssetForDeletion("");
  };
  ...
  const onDeleteConfirmButtonClick = (e) => {
    ...
    deleteNFTAssetAPI(
      selectedNFTAssetForDeletion.requestid,
  ...
  function onNFTAssetListSuccess(response) {
    console.log("onNFTAssetListSuccess: Starting...");
    if (response.results !== null) {
      setNFTAssets(response);
  ...
  function onNFTAssetListError(apiErr) {
    console.log("onNFTAssetListError: Starting...");
    setErrors(apiErr);
  ...
  function onNFTAssetListDone() {
    console.log("onNFTAssetListDone: Starting...");
    setFetching(false);
  }
  ...
  function onNFTAssetDeleteSuccess(response) {
    ...
    setTopAlertMessage("NFTAsset deleted");
    setTimeout(() => {
      console.log(
    ...
    fetchNFTAssetList(currentCursor, id, pageSize);
  }
    ...
    <>
      <div class="container">
        <section class="section">
          ...
          {/* Modals */}
          <div
            class={`modal ${selectedNFTAssetForDeletion ? "is-active" : ""}`}
          >
            ...
            <div class="modal-card">
              <header class="modal-card-head">
                ...
                <button
                  class="delete"
                  aria-label="close"
                  onClick={onDeselectNFTAssetForDeletion}
                ></button>
              </header>
...
export default AdminCollectionDetailForNFTAssetList;
