...
import { postNFTAssetCreateAPI } from "../../../../../API/NFTAsset";
...
function AdminCollectionNFTAssetAdd() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = (e) => {
    ...
    postNFTAssetCreateAPI(
      formData,
      onAdminCollectionNFTAssetAddSuccess,
      onAdminCollectionNFTAssetAddError,
      onAdminCollectionNFTAssetAddDone,
      onUnauthorized,
    );
  ...
  function onAdminCollectionNFTAssetAddSuccess(response) {
    // For debugging purposes only.
    console.log("onAdminCollectionNFTAssetAddSuccess: Starting...");
    ...
    setTimeout(() => {
      ...
      console.log(
        "onAdminCollectionNFTAssetAddSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionNFTAssetAddError(apiErr) {
    console.log("onAdminCollectionNFTAssetAddError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log("onAdminCollectionNFTAssetAddError: Delayed for 2 seconds.");
      console.log(
        "onAdminCollectionNFTAssetAddError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminCollectionNFTAssetAddDone() {
    console.log("onAdminCollectionNFTAssetAddDone: Starting...");
    setFetching(false);
  }
...
export default AdminCollectionNFTAssetAdd;
