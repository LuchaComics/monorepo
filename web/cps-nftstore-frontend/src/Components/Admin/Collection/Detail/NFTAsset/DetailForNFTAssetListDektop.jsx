...
function AdminCollectionDetailForNFTAssetListDesktop(props) {
  const {
    collectionID,
    listData,
    setPageSize,
                  ...
                  <tr>
                    ...
                    <td class="is-actions-cell">
                      <div class="buttons is-right">
                        ...
                        <button
                          onClick={(e, ses) =>
                            onSelectNFTAssetForDeletion(e, pinObject)
                          }
...
export default AdminCollectionDetailForNFTAssetListDesktop;
