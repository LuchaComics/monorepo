...
import {
  ...
  topAlertStatusState,
  currentUserState,
  collectionFilterShowState,
  collectionFilterTemporarySearchTextState,
  collectionFilterActualSearchTextState,
  collectionFilterStatusState,
  collectionFilterRoleState,
  collectionFilterJoinedAfterState,
} from "../../../../AppState";
...
function AdminNFTCollectionList() {
  ...
  const [showFilter, setShowFilter] = useRecoilState(collectionFilterShowState); // Filtering + Searching
  ...
  const [status, setStatus] = useRecoilState(collectionFilterStatusState); // Filtering
  const [role, setRole] = useRecoilState(collectionFilterRoleState); // Filtering
  ...
  function onCollectionListSuccess(response) {
    console.log("onCollectionListSuccess: Starting...");
  ...
  function onCollectionListError(apiErr) {
    console.log("onCollectionListError: Starting...");
    setErrors(apiErr);
  ...
  function onCollectionListDone() {
    console.log("onCollectionListDone: Starting...");
    setFetching(false);
  }
  ...
  const fetchList = (cur, limit, keywords, s, r, j) => {
    ...
    getCollectionListAPI(
      params,
      onCollectionListSuccess,
      onCollectionListError,
      onCollectionListDone,
      onUnauthorized,
    );
  };
          ...
          <nav class="box">
            ...
            {isFetching ? (
              ...
              <>
                ...
                {collections &&
                collections.results &&
                (collections.results.length > 0 || previousCursors.length > 0) ? (
                  <div class="container">
                    {/*
                        ##################################################################
