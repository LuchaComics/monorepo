...
function AdminNFTCollectionNFTUpdate() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = (e) => {
    ...
    putNFTUpdateAPI(
      rid,
      jsonData,
      onAdminNFTCollectionNFTUpdateSuccess,
      onAdminNFTCollectionNFTUpdateError,
      onAdminNFTCollectionNFTUpdateDone,
      onUnauthorized,
    );
  ...
  function onAdminNFTCollectionNFTUpdateSuccess(response) {
    // For debugging purposes only.
    console.log("onAdminNFTCollectionNFTUpdateSuccess: Starting...");
    ...
    setTimeout(() => {
      console.log("onAdminNFTCollectionNFTUpdateSuccess: Delayed for 2 seconds.");
      console.log(
        "onAdminNFTCollectionNFTUpdateSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminNFTCollectionNFTUpdateError(apiErr) {
    console.log("onAdminNFTCollectionNFTUpdateError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log("onAdminNFTCollectionNFTUpdateError: Delayed for 2 seconds.");
      console.log(
        "onAdminNFTCollectionNFTUpdateError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminNFTCollectionNFTUpdateDone() {
    console.log("onAdminNFTCollectionNFTUpdateDone: Starting...");
    setFetching(false);
  }
...
export default AdminNFTCollectionNFTUpdate;
