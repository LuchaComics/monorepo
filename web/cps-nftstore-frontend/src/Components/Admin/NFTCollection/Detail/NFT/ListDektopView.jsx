...
function AdminNFTCollectionDetailForNFTListDesktop(props) {
  const {
    collectionID,
    listData,
    setPageSize,
                  ...
                  <tr>
                    ...
                    <td class="is-actions-cell">
                      <div class="buttons is-right">
                        <Link
                          to={`/admin/collection/${collectionID}/nft/${datum.id}`}
                        ...
                        <button
                          onClick={(e, ses) =>
                            onSelectNFTForDeletion(e, datum)
                          }
...
export default AdminNFTCollectionDetailForNFTListDesktop;
