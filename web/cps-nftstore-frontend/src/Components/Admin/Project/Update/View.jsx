...
import { getProjectDetailAPI, putProjectUpdateAPI } from "../../../../API/Project";
...
function AdminProjectUpdate() {
  ...
  const onSubmitClick = (e) => {
    ...
    putProjectUpdateAPI(
      project,
      onAdminProjectUpdateSuccess,
      onAdminProjectUpdateError,
      onAdminProjectUpdateDone,
      onUnauthorized,
    );
  };
  ...
  function onAdminProjectUpdateSuccess(response) {
    // For debugging purposes only.
    console.log("onAdminProjectUpdateSuccess: Starting...");
    console.log(response);

    // Add a temporary banner message in the app and then clear itself after 2 seconds.
    setTopAlertMessage("Project updated");
    setTopAlertStatus("success");
    setTimeout(() => {
      console.log("onAdminProjectUpdateSuccess: Delayed for 2 seconds.");
      console.log(
        "onAdminProjectUpdateSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
    ...
    setForceURL("/admin/project/" + response.id);
  }

  function onAdminProjectUpdateError(apiErr) {
    console.log("onAdminProjectUpdateError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log("onAdminProjectUpdateError: Delayed for 2 seconds.");
      console.log(
        "onAdminProjectUpdateError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminProjectUpdateDone() {
    console.log("onAdminProjectUpdateDone: Starting...");
    setFetching(false);
  }
        ...
        <section class="section">
          ...
          <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link to={`/admin/project/${id}`} aria-current="page">
