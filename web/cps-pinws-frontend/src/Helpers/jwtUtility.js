...
export function setAccessTokenInLocalStorage(accessToken) {
  if (accessToken !== undefined && accessToken !== null) {
    localStorage.setItem("CPS_TOKEN_UTILITY_ACCESS_TOKEN_DATA", accessToken);
  } else {
...
export function setRefreshTokenInLocalStorage(accessToken) {
  if (accessToken !== undefined && accessToken !== null) {
    localStorage.setItem("CPS_TOKEN_UTILITY_REFRESH_TOKEN_DATA", accessToken);
  } else {
...
export function getAccessTokenFromLocalStorage() {
  return localStorage.getItem("CPS_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
}
...
export function getRefreshTokenFromLocalStorage() {
  return localStorage.getItem("CPS_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
...
export function clearAllAccessAndRefreshTokensFromLocalStorage() {
  localStorage.removeItem("CPS_TOKEN_UTILITY_ACCESS_TOKEN_DATA");
  localStorage.removeItem("CPS_TOKEN_UTILITY_REFRESH_TOKEN_DATA");
}
