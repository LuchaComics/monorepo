...
function AdminTenantPinObjectUpdate() {
  ////
  //// URL Parameters.
  ////
  ...
  const onSubmitClick = (e) => {
    ...
    putPinObjectUpdateAPI(
      id,
      formData,
      onAdminTenantPinObjectUpdateSuccess,
      onAdminTenantPinObjectUpdateError,
      onAdminTenantPinObjectUpdateDone,
      onUnauthorized,
    );
  ...
  function onAdminTenantPinObjectUpdateSuccess(response) {
    // For debugging purposes only.
    console.log("onAdminTenantPinObjectUpdateSuccess: Starting...");
    console.log(response);

    // Add a temporary banner message in the app and then clear itself after 2 seconds.
    setTopAlertMessage("PinObject updated");
    setTopAlertStatus("success");
    setTimeout(() => {
      console.log(
        "onAdminTenantPinObjectUpdateSuccess: Delayed for 2 seconds.",
      );
      console.log(
        "onAdminTenantPinObjectUpdateSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
    ...
    // Redirect the tenant to the tenant pinobjects page.
    setForceURL("/admin/tenant/" + id + "/pinobjects");
  }

  function onAdminTenantPinObjectUpdateError(apiErr) {
    console.log("onAdminTenantPinObjectUpdateError: Starting...");
    setErrors(apiErr);
    ...
    setTimeout(() => {
      console.log("onAdminTenantPinObjectUpdateError: Delayed for 2 seconds.");
      console.log(
        "onAdminTenantPinObjectUpdateError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus,
      );
      setTopAlertMessage("");
  ...
  function onAdminTenantPinObjectUpdateDone() {
    console.log("onAdminTenantPinObjectUpdateDone: Starting...");
    setFetching(false);
  }
        ...
        <section class="section">
          ...
          <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link
                  to={`/admin/tenant/${id}/pinobject/${aid}`}
                  aria-current="page"
                >
...
export default AdminTenantPinObjectUpdate;
