...
import {
  ...
  topAlertStatusState,
  currentUserState,
  projectFilterShowState,
  projectFilterTemporarySearchTextState,
  projectFilterActualSearchTextState,
  projectFilterStatusState,
  projectFilterRoleState,
  projectFilterJoinedAfterState,
} from "../../../../AppState";
...
import AdminProjectListDesktop from "./ListDesktop";
import AdminProjectListMobile from "./ListMobile";
...
function AdminProjectList() {
  ...
  const [showFilter, setShowFilter] = useRecoilState(projectFilterShowState); // Filtering + Searching
  ...
  const [status, setStatus] = useRecoilState(projectFilterStatusState); // Filtering
  const [role, setRole] = useRecoilState(projectFilterRoleState); // Filtering
  ...
  function onProjectListSuccess(response) {
    console.log("onProjectListSuccess: Starting...");
  ...
  function onProjectListError(apiErr) {
    console.log("onProjectListError: Starting...");
    setErrors(apiErr);
  ...
  function onProjectListDone() {
    console.log("onProjectListDone: Starting...");
    setFetching(false);
  }
          ...
          <nav class="box">
            ...
            {isFetching ? (
              ...
              <>
                ...
                {projects &&
                projects.results &&
                (projects.results.length > 0 || previousCursors.length > 0) ? (
                  <div class="container">
                    {/*
                        ##################################################################
                  ...
                  <section class="hero is-medium has-background-white-ter">
                    <div class="hero-body">
                      ...
                      <p class="subtitle">
                        ...
                        to get started creating your first project.
                      </p>
                    </div>
                  </section>
                )}
