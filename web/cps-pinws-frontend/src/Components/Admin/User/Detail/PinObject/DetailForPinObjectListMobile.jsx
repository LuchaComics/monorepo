...
*/
function AdminUserDetailForPinObjectListMobile(props) {
  const {
    userID,
    listData,
    setPageSize,
            ...
            <div class="mb-5">
              ...
              <div class="is-hidden-mobile pt-2">
                <div className="buttons is-right">
                  <Link
                    to={`/admin/user/${userID}/pinobject/${datum.id}`}
                  ...
                  <Link
                    to={`/admin/user/${userID}/pinobject/${datum.id}/edit`}
...
export default AdminUserDetailForPinObjectListMobile;
